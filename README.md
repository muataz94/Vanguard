...
- استبدل `whatsappNumber` برقم دولي من 10 إلى 15 رقماً بلا `+` أو مسافات. الروابط معطلة بأمان حتى ذلك الحين.
- استبدل بريد المثال.
...
- [ ] اختبار كل رسالة واتساب بعد وضع الرقم الحقيقي، مع عدم إرسال بيانات حساسة للتحليلات.
