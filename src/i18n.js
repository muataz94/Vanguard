...
const ar = {
  ...
  'hero.lead': 'مؤشر تحليلي لمنصة TradingView يساعدك على تنظيم مناطق المتابعة، مراجعة شروط الإشارة، واستلام التنبيهات على هاتفك—مع بقاء قرار التداول وإدارة المخاطر بيدك.',
  ...
  'hero.riskLabel': 'تنبيه مخاطر:',
  'hero.risk': 'فانگارد أداة تحليلية مساعدة ولا يضمن الربح. التداول قد يؤدي إلى خسارة جزء أو كامل رأس المال.',
  'chart.eyebrow': 'رسم السوق التفاعلي',
  'chart.title': 'حركة الذهب مقابل الدولار',
  'chart.loading': 'جارٍ تحميل الرسم التفاعلي…',
  'chart.errorTitle': 'تعذر تحميل الرسم التفاعلي حالياً.',
  'chart.errorCopy': 'يمكنك متابعة السوق وفتح مؤشر Vanguard مباشرة على TradingView.',
  'chart.open': 'فتح المؤشر على TradingView',
  'chart.clarification': 'الرسم التفاعلي لعرض حركة السوق — افتح المؤشر على TradingView لعرض إشارات Vanguard.',
  'chart.openFull': 'افتح مؤشر Vanguard على TradingView',
  'chart.risk': 'أداة تحليلية مساعدة وليست توصية مالية أو ضماناً للنتائج.',
  ...
  'markets.indicators.description': 'استعرض أمثلة لأدوات تحليل مختلفة وقارن طريقة عرض الاتجاه والزخم والإشارات.',
  'markets.indicators.clarification': 'الأسماء الأخرى مذكورة لأغراض المقارنة فقط ولا تعني وجود شراكة أو اعتماد.',
...
const en = {
  ...
  'hero.lead': 'A TradingView analysis indicator that helps organize review zones, assess signal conditions, and receive mobile alerts—while every trading and risk decision remains yours.',
  ...
  'hero.riskLabel': 'Risk notice:', 'hero.risk': 'Vanguard is a supporting analysis tool and does not guarantee profit. Trading may result in losing some or all of your capital.',
  'chart.eyebrow': 'Interactive market chart', 'chart.title': 'Gold against the US dollar', 'chart.loading': 'Loading the interactive chart…',
  'chart.errorTitle': 'The interactive chart is currently unavailable.', 'chart.errorCopy': 'You can follow the market and open Vanguard Indicator directly on TradingView.',
  'chart.open': 'Open on TradingView', 'chart.clarification': 'The interactive chart shows market movement—open the indicator on TradingView to view Vanguard signals.',
  'chart.openFull': 'Open Vanguard Indicator on TradingView', 'chart.risk': 'A supporting analysis tool, not financial advice or a guarantee of results.',
  ...
  'markets.visualAria': 'Local demonstration chart that does not show live market data', 'markets.demo': 'Demonstration preview',
  ...
  'markets.indicators.title': 'Indicator Review', 'markets.indicators.description': 'Explore examples of different analysis tools and compare how they present trends, momentum, and signals.',
  'markets.indicators.clarification': 'Other names are shown for comparison only and do not imply partnership or endorsement.',
